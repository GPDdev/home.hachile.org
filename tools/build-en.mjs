...
const translations = {
  ...
  '到机器人与人工智能的探索者。': 'to exploring robotics and AI.',
  '曾经选科物化生、热衷政史地；现在就读于同济大学机器人专业，正在探索具身智能、世界模型等科研方向。Gunpowder 这个头像和网名从 2020 年开始使用。': 'I studied physics, chemistry, and biology while also enjoying history, politics, and geography. Now I study robotics at Tongji University and explore embodied AI and world models. I have used the Gunpowder name and avatar since 2020.',
  '学校': 'University', '同济大学': 'Tongji University', '专业': 'Major', '机器人': 'Robotics',
  '关注': 'Focus', '具身智能 · 世界模型': 'Embodied AI · World models', '社群': 'Communities',
  '100+ 个网络社群': '100+ online communities',
  '喜欢历史、时政、人文地理；偶尔打音游、P 社游戏和 io 小游戏。也对军事、城市规划、哲学、轨道交通、板绘与作曲感兴趣。': 'I enjoy history, current affairs, and human geography, plus rhythm games, Paradox games, and io games. I am also interested in military studies, urban planning, philosophy, rail transit, digital art, and composition.',
